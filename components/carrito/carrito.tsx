...
export const Carrito = () => {
    const { carrito, eliminarItem, editarCantidad, vaciarCarrito } =
        useCarritoState();
        ...
        <section className="fixed right-5 bottom-20 z-50">
            {
                !isActive &&
                <Button
                    className="neo-button relative flex items-center justify-center w-11 h-11 me-3 bg-primary text-primary-foreground hover:shadow-[6px_6px_0px_0px_theme(colors.border)] transition-all duration-200"
            ...
            {isActive &&
                ...
                createPortal(
                    <>
                        ...
                        >
                            <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[95%] max-w-lg max-h-[80dvh] flex flex-col neo-card bg-background shadow-[8px_8px_0px_0px_theme(colors.border)]">
